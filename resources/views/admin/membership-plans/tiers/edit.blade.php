...
<div class="content">
    ...
    <div class="block block-rounded">
        ...
        <div class="block-content">
            ...
            <form method="POST" action="{{ route('admin.membership-plans.tiers.update', [$membership, $tier]) }}">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" min="0" name="annual_fee" class="form-control" value="{{ old('annual_fee', $tier->annual_fee) }}" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">Target Audience</label>
                    <input type="text" name="target_audience" class="form-control" value="{{ old('target_audience', $tier->target_audience) }}" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">Benefits</label>
                    <textarea name="benefits" class="form-control" rows="5" placeholder="One benefit per line or comma-separated">{{ old('benefits', implode("\n", (array) $tier->benefits)) }}</textarea>
                </div>
                <div class="mb-3">
