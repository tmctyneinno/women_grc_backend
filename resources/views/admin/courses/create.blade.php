    ...
    <form action="{{ route('admin.courses.store') }}" method="POST">
        ...
        <div class="row g-3">
            <div class="col-lg-8">
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Course Basics</h3>
                    </div>
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Learning Settings</h3>
                    </div>
                    <div class="block-content">
                        <div class="row">
                            <div class="col-md-6 mb-4">
            ...
            <div class="col-lg-4">
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Publish & Access</h3>
                    </div>
                    <div class="block-content">
                        <div class="mb-4 form-check form-switch">
                        ...
                        <div class="alert alert-info mb-0">
                            Tip: Publish courses when all modules and lessons are ready.
                        </div>
                    </div>
                </div>
