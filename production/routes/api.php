...
Route::middleware('api')->prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->prefix('mentors')->group(function () {
        Route::get('/', [MentorController::class, 'index']);
        Route::get('/{mentor}', [MentorController::class, 'show']);
        Route::post('/{mentor}/apply', [MentorController::class, 'apply']);
        Route::post('/apply-as-mentor', [MentorController::class, 'applyAsMentor']);
    });

    Route::middleware('auth:sanctum')->prefix('mentorships')->group(function () {
        Route::get('/applications', [MentorshipController::class, 'applications']);
        Route::post('/applications/{application}/accept', [MentorshipController::class, 'accept']);
        Route::post('/applications/{application}/decline', [MentorshipController::class, 'decline']);
        Route::get('/my', [MentorshipController::class, 'myMentorships']);
        Route::get('/{mentorship}', [MentorshipController::class, 'show']);
        Route::post('/{mentorship}/milestones', [MentorshipController::class, 'addMilestone']);
        Route::patch('/{mentorship}/milestones/{milestone}', [MentorshipController::class, 'updateMilestone']);
        Route::post('/{mentorship}/sessions', [MentorshipController::class, 'addSession']);
        Route::patch('/{mentorship}/sessions/{session}', [MentorshipController::class, 'updateSession']);
        Route::post('/{mentorship}/notes', [MentorshipController::class, 'addNote']);
        Route::post('/{mentorship}/feedback', [MentorshipController::class, 'addFeedback']);
        Route::post('/{mentorship}/complete', [MentorshipController::class, 'complete']);
    });
